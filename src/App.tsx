                            ...
                            <div key={product.id} className="p-4 rounded-lg bg-gray-50/80 dark:bg-gray-800/80 hover:bg-gray-100/80 dark:hover:bg-gray-700/80 transition-colors">
                              ...
                              <div className="flex justify-between items-center">
                                <a
                                  ...
                                  className="w-full inline-flex justify-center items-center px-4 py-2.5 bg-green-300 hover:bg-green-400 text-white rounded-lg text-sm font-medium transition-all duration-500 transform hover:scale-[1.02] active:scale-[0.98]"
                                >
